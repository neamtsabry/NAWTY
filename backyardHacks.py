...
def get_populartimes_from_search(place_identifier):
    ...
    :return:
    """
    params_url = {"tbm": "map","tch": 1,"hl": "en","q": urllib.parse.quote_plus(place_identifier),"pb": "!4m12!1m3!1d4005.9771522653964!2d-122.42072974863942!3d37.8077459796541!2m3!1f0!2f0!3f0!3m2!1i1125!2i976""!4f13.1!7i20!10b1!12m6!2m3!5m1!6e2!20e3!10b1!16b1!19m3!2m2!1i392!2i106!20m61!2m2!1i203!2i100!3m2!2i4!5b1"
    ...
    resp = urllib.request.urlopen(urllib.request.Request(url=search_url, data=None, headers=USER_AGENT),context=gcontext)
...
def get_populartimes_by_detail(api_key, detail):
    ...
    detail_json = {"id": detail["place_id"],"name": detail["name"],"address": address,"types": detail["types"],"coordinates": detail["geometry"]["location"]}
...
for i in pTimes:
    print(i['name'],end=": ")
    print(round(Average(i['data']),2),end="\n")
